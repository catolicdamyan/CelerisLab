...
with open('C:/Users/Catolic Damyan/Downloads/Celeris/Jose/runb/config.json', 'r') as f:
    config = json.load(f)
...
# Cargar batimetría
bathy_data = np.loadtxt('C:/Users/Catolic Damyan/Downloads/Celeris/Jose/runb/bathy.txt')
