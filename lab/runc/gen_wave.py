...
data_file = "17_09_15_20.001(F).txt"  # archivo de entrada (2 columnas: tiempo, señal)
#data_file = "runb_short.txt"
out_file = "waves.txt"            # archivo de salida
...
with open(out_file, "w") as fh:
    ...
    fh.write("=================================\n")
    fh.write("\n")  # tercera cabecera (evita IndexError en Celeris)
