...
with open('C:/Users/Catolic Damyan/Downloads/Celeris/Jose/rund/config.json', 'r') as f:
    config = json.load(f)
...
# Cargar batimetría
bathy_data = np.loadtxt('C:/Users/Catolic Damyan/Downloads/Celeris/Jose/rund/bathy.txt')
